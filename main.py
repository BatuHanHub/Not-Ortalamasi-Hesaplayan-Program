...
dersAdiFrame = Frame(pencere)
ustMenuFrame = Frame(pencere,bg='grey')

not1Frame.place(relx=0.1,rely=0.2,relheight=0.10,relwidth=0.50)
not2Frame.place(relx=0.1,rely=0.4,relheight=0.10,relwidth=0.50)
